 ...
 * This file demonstrates how to integrate Emberorbit with a web frontend
 */

// For React/Vue/Angular applications
export class EmberorbitClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EmberorbitClient(provider, contractAddress);
